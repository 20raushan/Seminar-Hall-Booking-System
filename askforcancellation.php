  ...
  <div class='container'>
    <div class='panel panel-primary dialog-panel'>
      <div class='panel-heading'>
        <h1><center><b>UPDATE THE EXISTING ENTRY</b></center></h1>
	  ...
	  echo"<tr><td>".$row["hall_name"]."</td><td>".$row["projector"]."</td><td>".$row["type_of_desk"]."</td><td>".$row["no_of_desk"]."</td><td>".$row["room_type"]."</td>
	                 <td>";
					  ?><form action="askforupdation.php" method="POST">
	                 ...
	                 if(isset($_POST["delete"]))
					   {   
						  ...
						  // {//echo"<script> alert('deleted successfully');</script>";
	                        echo"<script>window.location.href='askforupdation.php?user=<?php echo $name;?></script>";
						  // }
